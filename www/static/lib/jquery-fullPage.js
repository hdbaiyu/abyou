...
(function(c, l) { "function" === typeof define && define.amd ? define(["jquery"], function(m) { return l(m, c, c.document, c.Math) }) : "undefined" !== typeof exports ? module.exports = l(require("jquery"), c, c.document, c.Math) : l(jQuery, c, c.document, c.Math) })("undefined" !== typeof window ? window : this, function(c, l, m, p, H) {
    ...
    c.fn.fullpage = function(d) {
        ...
        function Va(a) {
            if (d.css3 && d.autoScrolling && !d.scrollBar) wa("translate3d(0px, -" + a.dtop + "px, 0px)", !0), d.scrollingSpeed ? ca = setTimeout(function() { da(a) }, d.scrollingSpeed) : da(a);
            else {
                var b = Wa(a);
        ...
        function F(a, b) {
            ...
            if (d.onSlideLeave) {
                ...
                if (!n && "none" !== t && c.isFunction(d.onSlideLeave) && !1 === d.onSlideLeave.call(r, k, h + 1, q, t, f)) { z = !1; return }
            }
